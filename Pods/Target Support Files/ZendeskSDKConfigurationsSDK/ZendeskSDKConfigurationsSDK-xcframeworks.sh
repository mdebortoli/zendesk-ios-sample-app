...
install_xcframework "${PODS_ROOT}/ZendeskSDKConfigurationsSDK/SDKConfigurations.xcframework" "SDKConfigurations" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
